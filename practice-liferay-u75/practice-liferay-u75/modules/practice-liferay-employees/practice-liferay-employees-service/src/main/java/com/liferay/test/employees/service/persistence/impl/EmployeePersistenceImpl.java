...
package com.liferay.test.employees.service.persistence.impl;
...
import com.liferay.test.employees.exception.NoSuchEmployeeException;
import com.liferay.test.employees.model.Employee;
import com.liferay.test.employees.model.EmployeeTable;
import com.liferay.test.employees.model.impl.EmployeeImpl;
import com.liferay.test.employees.model.impl.EmployeeModelImpl;
import com.liferay.test.employees.service.persistence.EmployeePersistence;
import com.liferay.test.employees.service.persistence.EmployeeUtil;
import com.liferay.test.employees.service.persistence.impl.constants.PRACTICE_LIFERAYPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	/**
	 * Returns the employee where email = &#63; or throws a <code>NoSuchEmployeeException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public Employee findByEmail(String email) throws NoSuchEmployeeException {
	 ...
	 */
	@Override
	public Employee removeByEmail(String email) throws NoSuchEmployeeException {
	...
	@Override
	@Reference(
		target = PRACTICE_LIFERAYPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = PRACTICE_LIFERAYPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
