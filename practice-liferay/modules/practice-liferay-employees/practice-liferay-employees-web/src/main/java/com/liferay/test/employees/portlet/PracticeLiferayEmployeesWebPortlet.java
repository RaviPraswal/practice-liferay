package com.liferay.test.employees.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=PracticeLiferayEmployeesWeb",
...
public class PracticeLiferayEmployeesWebPortlet extends MVCPortlet {
}